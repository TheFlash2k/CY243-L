...
void printFlag() {
    ...
    char url[0xFF];
    char cmd[0xFF];
    char base[] = { 0x68,0x74,0x74,0x70,0x3a,0x2f,0x2f,0x31,0x37,0x32,0x2e,0x31,0x37,0x2e,0x30,0x2e,0x31,0x3a,0x39,0x35,0x31,0x34,0x2f,0x66,0x6c,0x61,0x67,0x00 };
    sprintf(url, "%s?chal_id=%s&team_id=%s", base, chal_id, team_id);
    printf("\033[0;32mGood job!\033[0m. Here's your flag: ");
